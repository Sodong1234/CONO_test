...
<body>
	...
	<section style="position: relative; bottom: 700px; z-index: 1">
		<form class="form-member" action="memberInfo_modify" method="post" style="width:1000px; margin: auto;">
			<div class="title-style">
				<a href="#" class="txt" >회원 정보 수정</a>
				<br>
			</div>
			<table class="table-style">
				<tbody>
					<tr>
						<th>닉네임</th>
						<td>
							<div class="input-text" style="inline-block: inline-block; vertical-align: middle">
					...
					<tr>
						...
						<td>
							<div class="input-text" style="inline-block: inline-block; vertical-align: middle">
								<input type="text" name="member_phone" id="number" required="required" value="${member.member_phone }" placeholder="전화번호입력"><input type="button" class="table-style__phone" value="인증요청"><br>
								<input type="text" name="number" id="number" required="required" placeholder="인증번호"><input type="button" class="table-style__phone-check" value="확인"><br>
							</div>
						</td>
					</tr>
				</tbody>
