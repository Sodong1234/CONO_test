...
<body>
	...
	<div class="hh"><h1>후기 작성</h1></div>
		...
		<form action="AdminNoticeWrite" method="post">
					...
					<div class = "subject"><input type="text"  id="textBox" name="notice_subject" required="required" placeholder="리뷰 제목을 입력해주세요. "></div>
				
					<div class = "content"><textarea rows="30" cols="100"  id="notice_content" name="notice_content" required="required" placeholder="리뷰 내용을 입력해주세요. "></textarea></div>
