...
public class MsgChatDTO {
	...
	public void setMsgChat_content(String msgChat_content) {
		this.msgChat_content = msgChat_content;
	}
	public String getMsgChat_time() {
		return msgChat_time;
	}
	public void setMsgChat_time(String msgChat_time) {
