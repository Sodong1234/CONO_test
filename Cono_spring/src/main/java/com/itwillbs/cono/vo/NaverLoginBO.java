...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "qLyglZeUsoQI8ZbDZDI7"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "2CVTtHOcRq"; // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://localhost:8080/cono/naver_login";
